...
RadarPositionNavigationController::RadarPositionNavigationController(std::shared_ptr<DatabaseManager> dbManager): m_imuManager(dbManager, "/usr/share/crusader/WMM.COF"),
                                                                                                                m_imuSerialPortReader("/dev/ttyUSB0", 115200){
